...
#' @param fun the type of statistic to be measured
#' @param alpha confidence interval
#' @param ...
#'
#' @return a vector containing a list of various stats
#' @export
#'
#' @examples
mybootNew<-function(iter=10000,x,fun="mean",alpha=0.05,...){
  ...
  return(list(ci=ci,fun=fun,x=x, xstat=xstat, n=n, y=y, para=para, mat=mat, pte=pte))# Some output to use if necessary
}
